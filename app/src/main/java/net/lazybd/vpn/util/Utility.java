...
public class Utility {
    ...
    public static void startVpn(Context context, SockServer sockServer) {
        Intent i = new Intent(context, SocksVpnService.class)
                .putExtra(INTENT_NAME, sockServer.getName())
                .putExtra(INTENT_SERVER, sockServer.getHost())
                .putExtra(INTENT_PORT, sockServer.getPort())
                .putExtra(INTENT_ROUTE, ROUTE_ALL)
                .putExtra(INTENT_DNS, "8.8.8.8")
                .putExtra(INTENT_DNS_PORT, 53)
                .putExtra(INTENT_PER_APP, false)
                .putExtra(INTENT_IPV6_PROXY, false)
                .putExtra(INTENT_USERNAME, sockServer.getUsername())
                .putExtra(INTENT_PASSWORD, sockServer.getPassword());
